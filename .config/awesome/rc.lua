...
-- simple tiles and fullscreen layout are enough
local layouts =
{
...
tags = {}
for s = 1, screen.count() do
  -- Each screen has its own tag table. 6 tags are more than enough
