-- copy of /usr/share/awesome/lib/awful/widget/calendar_popup.lua
...
local function get_cal_wibox(caltype, args)
    ...
    -- @ADDED by manu
    local wibox_widget = caltype == "year" and wibox.widget.calendar.year or wibox.widget.calendar.month
    ...
    local widget = wibox.widget {
        ...
        -- @ADDED by manu
        widget = caltype == "months" and helpers.calendar_widget.months or wibox_widget
    }
...
-- @ADDED by manu
function calendar_popup.months(args)
    return get_cal_wibox("months", args)
end
